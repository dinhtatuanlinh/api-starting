...
const {
    ...
    editList,
    del,
} = require(__pathControllers + "redis");

const abc = require(__pathControllers + "abc");

let router = express.Router();
module.exports = (app) => {
    router.get("/abc", (req, res, next) => abc(req, res, next));
    ...
    router.put("/redis/editsingle", (req, res, next) =>
    ...
    router.get("/redis/getList/:key", (req, res, next) =>
